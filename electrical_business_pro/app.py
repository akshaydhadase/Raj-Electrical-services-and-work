...
class Setting(db.Model):
 id=db.Column(db.Integer,primary_key=True); company_name=db.Column(db.String(150),default='Spark Electrical Solutions'); tagline=db.Column(db.String(250),default='Professional Electrical & Tender Services'); phone=db.Column(db.String(50),default='+91 00000 00000'); email=db.Column(db.String(150),default='info@example.com'); instagram=db.Column(db.String(250),default='https://instagram.com/'); whatsapp=db.Column(db.String(50),default=''); address=db.Column(db.Text,default='Your business address'); about=db.Column(db.Text,default='Reliable electrical contracting, maintenance and project services.'); hero_title=db.Column(db.String(250),default='Powering Projects. Building Trust.'); hero_text=db.Column(db.Text,default='Electrical contracting, maintenance, industrial solutions and tender support.')
